...
class Property
{
    ...
    public function __construct(object $object, string $name, string $reference, bool $nullable = false, bool $required = false, Type|null $type = null, string|null $description = null, mixed $default = null, ?bool $readOnly = null)
    {
        $this->name = $name;
        $this->object = $object;
